...
class MyPlaylistsPageBlocBased extends StatefulWidget {
  static const routeName = '/my_playlists_bloc_based';

  @override
  _MyPlaylistsPageBlocBasedState createState() =>
      _MyPlaylistsPageBlocBasedState();
}

class _MyPlaylistsPageBlocBasedState extends State<MyPlaylistsPageBlocBased> {
